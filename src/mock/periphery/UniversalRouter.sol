...
import {RewardsCollector} from "./RewardsCollector.sol";
import {RouterParameters} from "./RouterImmutables.sol";
import {PaymentsImmutables, PaymentsParameters} from "./PaymentsImmutables.sol";
import {NFTImmutables, NFTParameters} from "./NFTImmutables.sol";
import {UniswapImmutables, UniswapParameters} from "src/mock/periphery/UniswapImmutables.sol";
import {Commands} from "./Commands.sol";
import {IUniversalRouter} from "./IUniversalRouter.sol";
import {BlastManager} from "src/mock/periphery/BlastManager.sol";
    ...
    BlastManager
{
    ...
    constructor(
        ...
        UniswapImmutables(
            UniswapParameters(
                params.v2Factory,
                params.ringV2Factory,
                params.fwrng,
                params.v3Factory,
                params.pairInitCodeHash,
                params.ringPairInitCodeHash,
